...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "--collection-name", type=str, default="EO:EUM:DAT:MSG:HRSEVIRI"
    )
    argparser.add_argument(
        "--t-start", type=isodate.parse_datetime, default="2015-04-14T09:00:00"
    )
    argparser.add_argument(
        "--t-end", type=isodate.parse_datetime, default="2015-04-14T13:00:00"
    )
